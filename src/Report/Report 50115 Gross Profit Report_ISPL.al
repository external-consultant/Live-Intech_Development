report 50115 "Gross Profit Report_ISPL"
{

    //T48610-N New report create
    ApplicationArea = All;
    Caption = 'Gross Profit Report – New';
                                ...
                                begin
                                    repeat
                                        ...
                                        if RecItem."Inventory Posting Group" <> 'SAMPLE' then begin
                                            ...
                                            RecGrossProfitG.Incoterm := RecSalesInvHeader."Shipment Method Code";
                                            ...
                                            IF RecValueEntry.FindSet() THEN //Changed to Findset
                                                REPEAT
                                                    ...
                                                    IF RecValueEntry2.FindSet() THEN //Changed to Findset
                                                        REPEAT
                                                            RecGrossProfitG."Other Revenue (LCY)" += RecValueEntry2."Sales Amount (Actual)"; //This is taking total of all the charges in the sales so called other revenue.
                                            ...
                                            IF RecSalesinvLines2.FindSet() THEN //Changed to Findset
                                                REPEAT
                                                    Clear(GeneralLedgerSetup);
                                                    GeneralLedgerSetup.ChangeCompany(Companies.Name);
                                            ...
                                            IF TotalDiscountAmount <> 0 THEN BEGIN
                                                ...
                                                IF TotalSalesInvoiceLineAmount <> 0 THEN
                                                    ...
                                                    RecGrossProfitG."Total Sales Discount" := (CurrentLineAmount / TotalSalesInvoiceLineAmount) * TotalDiscountAmount;
                                            END;


                                            //IC charges and cost calculation-start
                                            Clear(ICCOGSLCY);
                                            IF (RecGrossProfitG."SO No." <> '') and (IsAllICPurchase(RecGrossProfitG, Companies)) THEN
                                            //coment
                                            BEGIN
                                                Clear(ICCompanyList);
                                                Clear(ICCOGSLCY);
                                                ...
                                                //     REPEAT
                                                //Moved the code of SalesInvoiceLine to under the GRN ledger entry as there can be one or more IC Purchases.
                                                ...
                                                //Logic for getting the ICSalesInvoiceLines to replace the IC related So. 05-03-2025
                                                //Start
                                                SalesShipmentLine.ChangeCompany(Companies.Name);
                                                SalesShipmentLine.reset;
                                                SalesShipmentLine.SetRange("Order No.", RecGrossProfitG."SO No.");
                                                SalesShipmentLine.SetRange("No.", RecGrossProfitG."Item Code");
                                                if SalesShipmentLine.FindLast() then begin // We are finding the Sales Shipment number which has Order number in header in same company.
                                                    ...
                                                    if ItemLedgerEntry.FindSet() then begin //Using Shipment for finding the Sales ILE in same company.
                                                        repeat
                                                                        ...
                                                                        if PurchaseReceiptHeader.FindLast() then begin
                                                                            ...
                                                                            IF ICCompanyList.FindFirst() THEN
                                                                                REPEAT
                                                                                    ...
                                                                                    if ICRecSalesInvHeader.FindLast() then begin
                                                                                        CLEAR(ICSalesOrderInvoiceLines);
                                                                                        ...
                                                                                        if ICSalesOrderInvoiceLines.FindLast() then;
                                                                                    end;
                                                                                    ...
                                                                                    ICShipmentLine.SetRange("No.", RecGrossProfitG."Item Code");
                                                                                    if ICShipmentLine.FindLast() then begin
                                                                                        ...
                                                                                        ICILE.SetRange("Item No.", RecGrossProfitG."Item Code");
                                                                                        //ICILE.SetRange("Variant Code", RecGrossProfitG."Variant Code");
                                                                                        // ICILE.SetRange("Lot No.", FindGRNLedgerEntry."Lot No."); //We need to check if they require lot filter if only it is remaining same.
                                                                                        if ICILE.FindLast() then begin
                                                                                            Clear(InvoicedQty);
                                                                                            CLEAR(ICValueEntry);
                                                                                            ...
                                                                                            //Purchase Charges
                                                                                            ICValueEntry2.RESET;
                                                                                            ICValueEntry2.SETRANGE("Item Ledger Entry No.", ICILE."Entry No.");
                                                                                            ...
                                                                                            IF ICValueEntry2.FindSet() THEN
                                                                                                REPEAT
                                                                                                    IF ICValueEntry2."Item Charge No." = '01' THEN
                                                                                                        RecGrossProfitG."EXP-FRT" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                    ELSE
                                                                                                        IF ICValueEntry2."Item Charge No." = '02' THEN
                                                                                                            RecGrossProfitG."EXP-CDT" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                        ELSE
                                                                                                            IF ICValueEntry2."Item Charge No." = '03' THEN
                                                                                                                RecGrossProfitG."EXP-INS" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                            ELSE
                                                                                                                IF ICValueEntry2."Item Charge No." = '04' THEN
                                                                                                                    RecGrossProfitG."EXP-TRC" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                ELSE
                                                                                                                    IF ICValueEntry2."Item Charge No." = '05' THEN
                                                                                                                        RecGrossProfitG."EXP-THC" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                    ELSE
                                                                                                                        IF ICValueEntry2."Item Charge No." = '06' THEN
                                                                                                                            RecGrossProfitG."EXP-SERV" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                        ELSE
                                                                                                                            IF ICValueEntry2."Item Charge No." = '07' THEN
                                                                                                                                RecGrossProfitG."EXP-OTHER" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                            ELSE
                                                                                                                                IF ICValueEntry2."Item Charge No." = '09' THEN
                                                                                                                                    RecGrossProfitG."EXP-WH HNDL" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                                ELSE
                                                                                                                                    IF ICValueEntry2."Item Charge No." = '10' THEN
                                                                                                                                        RecGrossProfitG."EXP-INPC" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                                    ELSE
                                                                                                                                        IF ICValueEntry2."Item Charge No." = '21' THEN
                                                                                                                                            RecGrossProfitG."EXP-WH PACK" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                                        ELSE
                                                                                                                                            IF ICValueEntry2."Item Charge No." = '24' THEN
                                                                                                                                                RecGrossProfitG."EXP-COO" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                                            ELSE
                                                                                                                                                IF ICValueEntry2."Item Charge No." = '26' THEN
                                                                                                                                                    RecGrossProfitG."EXP-LEGAL" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                                                ELSE
                                                                                                                                                    IF ICValueEntry2."Item Charge No." = '32' THEN
                                                                                                                                                        RecGrossProfitG."REBATE TO CUSTOMER" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                                                    ELSE
                                                                                                                                                        IF ICValueEntry2."Item Charge No." = '33' THEN
                                                                                                                                                            RecGrossProfitG."DEMURRAGE CHARGES" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity)
                                                                                                                                                        ELSE
                                                                                                                                                            RecGrossProfitG."Other Charges" += ((ICValueEntry2."Cost Amount (Non-Invtbl.)" * -1) / InvoicedQty) * Abs(ItemApplicationEntry.Quantity);
                                                ...
                                                IF ICCOGSLCY <> 0 THEN begin
                                                    ...
                                                    /*//Temp to check which IC it is purchased from.
                                                    ICPartners.Reset();
                                                    ICPartners.SetRange("Vendor No.", PurchaseHeader."Buy-from Vendor No.");
                                                    if ICPartners.FindFirst() then
                                                        RecGrossProfitG."IC Company Code" := ICPartners.Code;*/
                                                end;
                                            END;
                                            //- IC end
                                                                            ...
                                                                            if RecICPartner."Inbox Type" = RecICPartner."Inbox Type"::Database then begin
                                                                                ...
                                                                                if RecVLE.FindFirst() then begin
                                                                                    ...
                                                                                    if RecPurchInvHdr.FindFirst() then begin
                                                                                        ...
                                                                                        RecGrossProfitG."Vendor Invoice No." := RecPurchInvHdr."Vendor Invoice No.";
                                                                                        // if RecGrossProfitG."Vendor Invoice No." = 'CP/PSI/100514' then
                                                                                        //     Message('Hello');
                                                                                    end;
                                                                                end;
                                                                            end;
    ...
    local procedure IsAllICPurchase(RecGrossProfitG: Record "Gross Profit Report"; Companies: Record Company): Boolean
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseReceiptHeader: Record "Purch. Rcpt. Header";
        PurchaseReceiptLine: Record "Purch. Rcpt. Line";
                ...
                repeat
                    ...
                    if ItemApplicationEntry.FindSet() then begin
                        repeat
                            ...
                            FindGRNLedgerEntry.Reset(); // Through Magic we found the Inbound ILE.
                            if FindGRNLedgerEntry.get(ItemApplicationEntry."Inbound Item Entry No.") and (FindGRNLedgerEntry."Document Type" = FindGRNLedgerEntry."Document Type"::"Purchase Receipt") then begin
                                Clear(PurchaseReceiptHeader); //After making sure that it is Purchase entry we are finding the GRN header which must have order.
                                PurchaseReceiptHeader.ChangeCompany(Companies.Name);
                                PurchaseReceiptHeader.Reset();
                                PurchaseReceiptHeader.SetRange("No.", FindGRNLedgerEntry."Document No.");
                                PurchaseReceiptHeader.SetFilter("Order No.", '<>%1', '');
                                if PurchaseReceiptHeader.FindLast() then begin
                                    ...
                                    IF PurchaseHeader.FindLAST() THEN begin
                                        Clear(ICPartner);
                                        ICPartner.ChangeCompany(Companies.Name);
                                        ICPartner.Reset();
                ...
                begin
                    repeat
                        ...
                        IF not ICPartners.FINDFIRST THEN begin
                            ...
                            if RecCustomerL."IC Company Code" = '' then begin
