report 50136 "6_Purchase Order R3 UAE"//T12370-Full Comment T12946-Code Uncommented
{
    DefaultLayout = RDLC;
    Caption = 'Purchase Order';
    RDLCLayout = 'Layouts/Purchase Order R3 UAE.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            begin
                ...
                ExchangeRate := '';
                //T52852-NS
                if CompanyName = 'Komishanghai_1' then
                    TotalAmt := Round(TotalAmt, 1, '=');
                //  Message('%1..%2', CompanyName, TotalAmt);
                //T52852-NE
