report 85207 "2024 IC Partner Breakup"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    ProcessingOnly = true;
    Caption = '2024 IC Partner Breakup';
    Description = 'T52067';
        ...
        dataitem(Company; Company)
        {
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                begin
                    ...
                    if PreSourceNo_gTxt <> "G/L Entry"."G/L Account No." + "G/L Entry"."Source No." then Begin
                        CustVenName_gTxt := '';
                    ...
                    End;
                    PreSourceNo_gTxt := "G/L Entry"."G/L Account No." + "G/L Entry"."Source No.";
                end;
    ...
    begin
        ExcelBuffer_gRecTmp.CreateNewBook('2024 IC Partner Breakup');
        ExcelBuffer_gRecTmp.WriteSheet('2024 IC Partner Breakup', CompanyName, UserId);
        ExcelBuffer_gRecTmp.SetFriendlyFilename('2024 IC Partner Breakup');
    ...
    begin
        ...
        ExcelBuffer_gRecTmp.AddInfoColumn(Report::"2024 IC Partner Breakup", false, false, false, false, '', ExcelBuffer_gRecTmp."cell type"::Text);
        ExcelBuffer_gRecTmp.NewRow();
    ...
    begin
        ...
        ExcelBuffer_gRecTmp.AddColumn("G/L Entry"."Source No.", false, '', false, false, false, '#,##0.00', ExcelBuffer_gRecTmp."cell type"::Text);
        ExcelBuffer_gRecTmp.AddColumn(CustVenName_gTxt, false, '', false, false, false, '#,##0.00', ExcelBuffer_gRecTmp."cell type"::Text);
    end;
