codeunit 50102 RepMgt_50102
{
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::DimensionManagement, OnEditDimensionSetOnBeforeEditDimEntries, '', false, false)]
    local procedure DimensionManagement_OnEditDimensionSetOnBeforeEditDimEntries(var EditDimSetEntries: Page "Edit Dimension Set Entries")
    begin
        Commit();
    end;
